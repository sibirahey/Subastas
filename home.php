...
<head>
  ...
  <link href="css/mediaQueries.css<?php echo "?".rand(0, 9999999); ?>" rel="stylesheet"/>
  ...
  <script type="text/javascript" src="scripts/jquery-1.12.4.js<?php echo "?".rand(0, 9999999); ?>"></script>
  <script type="text/javascript" src="scripts/jquery-ui.js<?php echo "?".rand(0, 9999999); ?>"></script>
  <script type="text/javascript" src="scripts/jssor.slider-22.2.8.debug.js<?php echo "?".rand(0, 9999999); ?>" ></script>
  <script type="text/javascript" src="scripts/dobPicker.min.js<?php echo "?".rand(0, 9999999); ?>"></script>
